...
CREATE TABLE `tb_auto_incre` (
  ...
  `cl_count` bigint NOT NULL,
  `cl_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cl_prefix` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tb_category` (
  `cl_id` bigint UNSIGNED NOT NULL,
  `cl_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tb_category` (`cl_id`, `cl_name`, `cl_description`, `cl_image`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Appetizers', 'teg', '999585_221122175103_image 4.png', '2022-11-15 13:45:57', '2022-11-22 12:21:48', NULL),
(67, 'Soups & Salads', 'sfsg', '685020_221122184642_image 5.png', '2022-11-22 13:16:44', '2022-11-22 13:16:44', NULL),
(68, 'Entrees', 'sdf', '899165_221122184721_image 8.png', '2022-11-22 13:17:23', '2022-11-22 13:17:23', NULL),
(69, 'Drinks', 'xcv', '613620_221122184754_image 9.png', '2022-11-22 13:17:55', '2022-11-22 13:17:55', NULL),
(70, 'Desserts', 'zxccnfg', '955769_221122184819_image 10.png', '2022-11-22 13:18:21', '2022-11-22 19:46:24', NULL);
...
CREATE TABLE `tb_recipe` (
  `cl_id` bigint UNSIGNED NOT NULL,
  `cl_category_id` bigint UNSIGNED NOT NULL,
  `cl_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cl_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cl_ingradient` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cl_instruction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, 'adf', '251188_161122125150_image 13.png', NULL, '', '', '2022-11-15 13:54:48', '2022-11-22 14:56:06', NULL),
(2, 1, 'cvcdcvdx', '412042_161122125033_image 15.png', '  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', '   xczcsc\r\nrtyurtyu\r\nftugyi\r\ngyujgh', '', '2022-11-16 07:12:00', '2022-11-16 07:20:35', NULL),
(3, 1, 'thrtgh', '536921_161122125354_image 14.png', NULL, '', '', '2022-11-16 07:23:55', '2022-11-16 07:23:55', NULL),
(4, 1, 'bnvb', '329612_161122125407_image 17.png', NULL, '', '', '2022-11-16 07:24:09', '2022-11-26 13:05:33', '2022-11-26 13:05:33'),
(5, 1, 'Ashta with Honey', '235020_161122125429_image 16.png', NULL, '', '', '2022-11-16 07:24:30', '2022-11-26 13:06:23', NULL),
(6, 1, 'jk', '491272_161122125443_image 18.png', NULL, '', '', '2022-11-16 07:24:49', '2022-11-16 07:24:49', NULL),
(7, 68, 'Kibbeh', '984796_221122190326_image 11.png', ' Kibbeh, a form of the Arabic word kubbah or \"ball,\" is a staple in Middle Eastern cuisine. Made out of lamb or beef, these football-shaped croquettes are a flavorful blend of fragrant herbs and spices, filling meat, and hearty bulgur wheat.', '<p>500 g minced meat<br />\r\n2-3 onions chopped<br />\r\n1 teaspoon 7 spice<br />\r\n1.5 tablespoon Kibbeh Spices (Kamouneh Spice Mix)<br />\r\n&frac12; teaspoon black pepper<br />\r\n1 tablespoon salt<br />\r\n1 cup chopped walnuts or pine nuts<br />\r\n2 tablespoon sumac<br />\r\n<br />\r\nFor the Kibbeh casing:<br />\r\n1 kilo fine bulgur wheat<br />\r\n1 kilo mince meat<br />\r\n2 onions<br />\r\n1.5 tablespoon Kibbeh Spices<br />\r\n1.5 tablespoon cornflour<br />\r\n1 teaspoon 7 spice<br />\r\n&frac12; teaspoon black pepper<br />\r\n1 tablespoon salt<br />\r\nSunflower or vegetable oil</p>\r\n', '<p>Soak the bulgur wheat in enough water to cover and set aside<br />\r\nTo make the filling, saut&eacute; the chopped onions in regular olive oil until golden on medium low heat<br />\r\nAdd 500g of minced meat to the onions and cook out the meat on medium high heat<br />\r\nAdd the 7 spice, kamouneh spices, black pepper and salt and use the back of your wooden spoon to break up the meat<br />\r\nWhen it is cooked turn off the heat and add the sumac and chopped walnuts. Taste to make any adjustments then cover and set aside<br />\r\nDrain the bulgur wheat and add to a large bowl. Take out the kilo of meat and prepare food processor<br />\r\nIn several batches, add the bulgur wheat and equal amounts of meat to the food processor and process until it clumps together and starts to roll in the processor bowl.<br />\r\nRoughly chop 2 onions to go in the food processor along with the 7 spices, kamouneh spices, black pepper and salt. Blitz well<br />\r\nWhen you have combined all the meat and bulgur wheat in a bowl, add the blitzed onion spice mix and the cornflour, then bring everything together preferably with your hands<br />\r\nIf it is too dry add a bit of water, you don&#39;t want it too loose, sticky or crumbly but so it holds together nicely. If you don&#39;t mind tasting a bit of raw meat check a tiny bit for saltiness and adjust as necessary<br />\r\nAdd approx half a cup of sunflower to a small bowl which you can dip your fingers into when shaping the kibbeh to avoid sticking. Clean your table and arrange a workflow with a large clean tray, the sunflower oil, the filling and the casing mix<br />\r\nTake some casing and roll into golf ball size, indent the middle then hollow out the inside with your index finger turning as you do so until you have a half shell. Add a spoon of filling and close up the casing. Compress well with your hands and shape into classic kibbeh morsels (see video)<br />\r\nLine up the kibbeh on the tray until you finish the filling<br />\r\nDeep fry your kibbeh morsels in sunflower or vegetable oil and serve with yoghurt dip</p>\r\n', '2022-11-22 13:34:36', '2022-11-26 13:17:45', NULL),
(8, 67, 'Shorbet Adas', '261515_261122125806_Shorbet Adas.jpg', ' It\'s basically pumpkin soup', '<p>Pumpkin</p>\r\n\r\n<p>Lime</p>\r\n', '<p>Get a big pot and pumpkin and lime. Eventually use them.</p>\r\n', '2022-11-26 12:58:54', '2022-11-26 12:58:54', NULL);
...
CREATE TABLE `tb_session_token` (
  `cl_id` bigint UNSIGNED NOT NULL,
  `cl_access_code` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_client_code` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(36, 'cb63d384aa3534da0e0548b3bfbf811558b7c98e249fba1bc90a27264640125f', '121212', '2022-11-27', '2022-11-22 06:26:38', '2022-11-22 06:26:38'),
(37, '2b67bd961a69e3553b0fe7d2d3f6b0b840a020d5bdbe812d477e098544b5578a', '121212', '2022-11-27', '2022-11-22 07:30:11', '2022-11-22 07:30:11'),
(38, '24e51b5c968fceebe892040b1e32aac8c6120f85b6ba9835fe0c916693fa850a', '121212', '2022-11-27', '2022-11-22 10:10:28', '2022-11-22 10:10:28'),
(39, 'e40db46fe484b7b6ee038841244b5db6f95284d1003c4415d80c5109a365a0ea', '121212', '2022-11-27', '2022-11-22 11:31:56', '2022-11-22 11:31:56'),
(40, '3b11433ed67e8c4d22311d020438d9b80ba6b8c2eeb33df083793803f2c8724f', '121212', '2022-11-27', '2022-11-22 19:45:59', '2022-11-22 19:45:59'),
(41, '685723fcd95294ca097a02297d00b2d3a0606f2702520f3a871163e4aa84443c', '121212', '2022-11-28', '2022-11-23 17:12:57', '2022-11-23 17:12:57'),
(42, '944db951ab2f6e2683db7d177c5beb5cbe5537ed8fefc173e4b77e9f84db3e58', '121212', '2022-11-29', '2022-11-24 14:33:27', '2022-11-24 14:33:27'),
(43, '8a759f6de0dff5edeca8499ad50c8bf8b5db1862e24491c012cf2507fae0d813', '121212', '2022-12-01', '2022-11-26 12:42:28', '2022-11-26 12:42:28'),
(44, '61a9edbb1b8c9156b6f00f8ea960ab74d4ff50ff72d66598f500b35cb566daba', '121212', '2022-12-02', '2022-11-26 21:44:33', '2022-11-26 21:44:33'),
(45, 'cafc6f8acafe2839e9feb8cf1d3b5ea900f65806d0d3034b19d62c4b225ac172', '112112113', '2022-12-02', '2022-11-26 23:46:38', '2022-11-26 23:46:38'),
(46, 'e88347ff2e831038400969703ba7374f3d3db3d182f1862016f039b506789a8c', '112112113', '2022-12-02', '2022-11-26 23:48:29', '2022-11-26 23:48:29');
...
CREATE TABLE `tb_users` (
  `cl_id` bigint UNSIGNED NOT NULL,
  `cl_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
  `cl_username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cl_password` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cl_first_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_last_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_birthday` date DEFAULT NULL,
  `cl_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_address` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_starting_year` bigint NOT NULL DEFAULT '1970',
  `cl_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_country_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `cl_state_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `cl_city_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `cl_currency` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_card_accept` tinyint(1) NOT NULL DEFAULT '0',
  `cl_forgot_password_1` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_forgot_password_2` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_register_1` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_register_2` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_expiry_date` date DEFAULT NULL,
  `cl_profile_pic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_user_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `cl_city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cl_logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(12, '112112113', 'admin', 'paul.phan@drexel.edu', 'paul.phan@drexel.edu', '$2y$10$xIB/sN9drZ8n7hITUYhClu2rduod66HmWDFDTbAPRAZL/mZRMhI6K', 'Paul', NULL, NULL, NULL, NULL, 1970, NULL, '0', '0', '0', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tb_auto_incre`
  MODIFY `cl_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tb_category`
--
ALTER TABLE `tb_category`
  MODIFY `cl_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `tb_recipe`
--
ALTER TABLE `tb_recipe`
  MODIFY `cl_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tb_session_token`
--
ALTER TABLE `tb_session_token`
  MODIFY `cl_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `tb_users`
  MODIFY `cl_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
