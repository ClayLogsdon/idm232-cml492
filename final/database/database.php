...
define('DB_USER', 'clayfara_cookbook');
define('DB_PASS', 'Lebanese2116!');
//define(DB_NAME, 'logger');
define('DB_NAME', 'clayfara_cookbook');
class database {
    ...
    public function callQueryRow($query, $values = null)
    {
        return $this->queryPDOFetchRow($query, $values); 
    }

    public function callQueryWithCount($query, $values = null)
    {
       return $this->queryPDOFetchAllWithCount($query, $values); 
    }
