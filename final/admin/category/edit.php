...
class Edit extends database{
	...
	{
    $where['cl_id'] = $id;
		return $this->fetchRow('tb_category', $where);
	}
...
<!--        <li class="breadcrumb-menu d-md-down-none">
      ...
      <div class="container">
        <div class="animated fadeIn">
            ...
            <div class="col-sm-12">
              <div class="card">
                <form method="post"  class="form_artist" cluster-url="../ajax/category/edit_ajax.php?id=<?php echo htmlspecialchars($id) ?>" cluster-redirect="list.php">
